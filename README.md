...
Conneted to Firebase - Realtime Database ( can be changed in ../src/containers/Notifications/Notification.js ). Initial polling time is set to 20s. Uses localStora to store the notifications data ( as which one are recieved, seen and deleted ).
